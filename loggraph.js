...
function Loggraph (targetDivName, tables, graph_id) {
  ...
  this.plot = $("<div/>").attr("class", "loggraph-display");
  ...
  this.selectPlot = function (i_plot) {
    this.plot.empty();
    var i_table = parseInt($(this.tableSelect).val());
    var table = this.tables[i_table];
    var data = table.data;
    ...
    this.plot.append(plot_name);
    var svg = d3.select(".loggraph-display").append("svg")
